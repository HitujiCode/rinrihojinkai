    ...
    <div class="p-works-overview__inner l-inner">
      ...
      <section class="p-works-overview__section p-archive-works">
        ...
        <div class="p-archive-works__button">
          <a href="<?php echo esc_url(get_term_link('normal', 'genre')); ?>" class="c-button">view all</a>
        </div>
      </section>
      <!-- 十三詣り -->
      <section class="p-works-overview__section p-archive-works l-common">
        ...
        <div class="p-archive-works__button">
          <a href="<?php echo esc_url(get_term_link('jusan-mairi', 'genre')); ?>" class="c-button">view all</a>
        </div>
      </section>
      <!-- ドローン -->
      <?php
      ...
      if ($drone_query->have_posts()) : ?>
        <section class="p-works-overview__section p-archive-works l-common">
          ...
          <div class="p-archive-works__button">
            <a href="<?php echo esc_url(get_term_link('drone', 'genre')); ?>" class="c-button">view all</a>
          </div>
        </section>
      <?php endwhile; ?>
    <?php endif;
